        ...
        <div class="signup-form">
            ...
            <form action="#" method="post" id="fileForm" role="form">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" required type="text" name="email" id="email" placeholder="Email ID" />
                    <div class="status" id="status"></div>
                </div>
                <div class="form-group">
                    <label for="contact_number"><span class="req"></span>
                        <b>Contact Number:</b>
                    </label>
                ...
                <div class="form-group">
                    <label for="city"><span class="req"></span>
                        <b> City:</b>
                    </label>
                ...
                <div class="form-group">
                    ...
                    <label for="confirm_password"><span class="req"></span>
